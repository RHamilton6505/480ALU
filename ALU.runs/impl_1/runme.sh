...
HD_PWD='C:/Users/Ian Hamilton/Documents/480/ALU/ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_Segment_BCD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Seven_Segment_BCD.tcl -notrace
